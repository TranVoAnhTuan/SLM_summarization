...
class TranslateModule:
    def __init__(self, device="cuda" if torch.cuda.is_available() else "cpu") -> None:
        ...
        self.en2vi_tokenizer = AutoTokenizer.from_pretrained("vinai/vinmt-translate-en2vi")
        self.en2vi_model = AutoModelForSeq2SeqLM.from_pretrained("vinai/vinmt-translate-en2vi").to(device)

        self.vi2en_tokenizer = AutoTokenizer.from_pretrained("vinai/vinmt-translate-vi2en")
        self.vi2en_model = AutoModelForSeq2SeqLM.from_pretrained("vinai/vinmt-translate-vi2en").to(device)
